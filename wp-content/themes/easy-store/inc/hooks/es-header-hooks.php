			...
			<div class="mt-container">
				...
				<nav id="site-navigation" class="main-navigation" role="navigation">
                    ...
                    if ( is_user_logged_in() ) {
                        wp_nav_menu( array( 'theme_location' => 'easy_store_primary_menu', 'menu_id' => 'primary-menu' ) );
                    } else {
                        wp_nav_menu( array( 'theme_location' => 'easy_store_footer_menu', 'menu_id' => 'footer-menu' ) );
                    }
					?>
				</nav><!-- #site-navigation -->
